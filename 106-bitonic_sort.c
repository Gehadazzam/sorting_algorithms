 ...
 */
void bitonic_merge(int *array, size_t size, size_t low, size_t count, char choose)
{
	size_t k = count / 2, i;
 ...
 */
void bitonic_sort_recursive(int *array, size_t size, size_t low, size_t count, char choose)
{
	size_t k = count / 2;
